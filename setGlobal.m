...
sigmaX = 0.1; %When you change this change Q as well. Actually not sure of this
sigmaZ = 0.1;
Q =  0.01 * diag(ones(6, 1)); %.01 a good value for 0.5/0.4
%Q =  .1 * (ones(6, 6)); %.01 a good value for 0.5/0.4
